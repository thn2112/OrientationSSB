...
res_dir = res_dir + 'sbi_l4_sel_mod_low_thresh/'
if not os.path.exists(res_dir):
    os.makedirs(res_dir)
...
if bayes_iter == 0:
    ...
    with open(f'./../notebooks/l4_highpass_pol_posterior_8.pkl','rb') as handle:
        full_prior = pickle.load(handle)
elif bayes_iter == 1:
    with open(f'./../notebooks/l4_highpass_pol_posterior_9.pkl','rb') as handle:
        full_prior = pickle.load(handle)
elif bayes_iter == 2:
    with open(f'./../notebooks/l4_highpass_pol_posterior_10.pkl','rb') as handle:
        full_prior = pickle.load(handle)
else:
    with open(f'./../notebooks/l4_low_thresh_posterior_{bayes_iter:d}.pkl','rb') as handle:
        full_prior = pickle.load(handle)
